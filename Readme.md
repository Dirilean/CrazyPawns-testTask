...
В данном проекте реализованы все описаные механики
Дополнительно реализовано следующее:
- Проект сделан для WebGl, залит на страницы гитхаб и доступен по ссылке: https://dirilean.github.io/CrazyPawns-testTask/
- Добавлена визуализация создания линии коннекта во время поиска конечной точки
- Реализован скрипт камеры и создания шахматной доски
- Реализовано пересоздание стартовой доски и пешек в объекте LevelController кнопками из редактора

# Текст задания Crazy Pawns
